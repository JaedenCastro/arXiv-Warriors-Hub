import argparse
# Used to be from utils.training import run_finetuning (original)
# Used to be import utils.training (fix a)
...
def main():
    ...
    # Set the DATA_DIR environment variable. Now uses hatespeech dataset
    #os.environ['DATA_DIR'] = 'Filipino-Text-Benchmarks/data/hatespeech'

    # Access the environment variable within the script
    #data_dir = os.environ['DATA_DIR']

    parser = argparse.ArgumentParser()
    # Run this from command line/command prompt/cmd
    # Dataset parameters
    ...
    parser.add_argument('--text_columns', type=str, default='text',
                        help='Column name(s) of the features. Comma-separated for entailment tasks')
    parser.add_argument('--label_columns', type=str, default='label',
                        help='Column name(s) of the labels to predict. Comma-separated for multilabels.')
    parser.add_argument('--retokenize_data', type=str2bool, default='false',
                        help='Force the script to generate data cache again.')
    ...
    parser.add_argument('--warmup_pct', type=float, default=0.1,
                        help='Percentage of the training steps to warmup learning rate.')
    ...
    # Run finetuning
    # Used to be run_finetuning(args) (original)
    # Used to be utils.training.run_finetuning(args) (fix 1-a)
